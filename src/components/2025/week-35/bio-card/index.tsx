          ...
          <div className={styles.controls}>
            <label className={styles.btn_toggle}>
              ...
              <span className={styles.icon}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgb(20 22 31)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`lucide lucide-chevron-down-icon lucide-chevron-down ${styles.arrow}`}>
                  <path d="m6 9 6 6 6-6"/>
                </svg>
              </span>
            </label>
      ...
      <div className={styles.bio_bottom_slide}>
        ...
        <div className={styles.socials}>
          <Link href="#" className={styles.socials_linkedin}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="rgb(159 255 0)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-linkedin-icon lucide-linkedin">
          ...
          <Link href="#" className={styles.socials_insta}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="rgb(159 255 0)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-instagram-icon lucide-instagram">
