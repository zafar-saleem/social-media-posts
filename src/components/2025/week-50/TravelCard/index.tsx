    ...
    <section className={styles.card}>
      <div className={styles.image}>
        ...
        <button className={`${styles.badge} ${styles.bookmark}`}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgb(255 255 255)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-bookmark-icon lucide-bookmark"><path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"/></svg>
        </button>
