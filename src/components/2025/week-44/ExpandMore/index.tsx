    ...
    <section className={styles.wrapper}>
      ...
      <div className={styles.container}>
        ...
        <label className={`${styles.button} ${styles.button_expand}`}>
          <input type="checkbox" />
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgb(193 193 193)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`lucide lucide-ellipsis-icon lucide-ellipsis ${styles.label_more}`}><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/></svg>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgb(193 193 193)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`${styles.label_close} lucide lucide-x-icon lucide-x`}><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
        </label>
        <button className={`${styles.button} ${styles.button_share}`}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgb(193 193 193)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-send-icon lucide-send"><path d="M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z"/><path d="m21.854 2.147-10.94 10.939"/></svg>
        </button>
